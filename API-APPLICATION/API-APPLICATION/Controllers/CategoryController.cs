    ...
    public class CategoryController : ApiController
    {
        ...
        public HttpResponseMessage AddCategory(CategoryDTO category)
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, "New Category has been inserted");
            }
            catch (Exception ex)
            {
        ...
        public HttpResponseMessage UpdateCategory(CategoryDTO category)
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, "Category has been updated");
            }
            catch (Exception ex)
            {
                return Request.CreateResponse(HttpStatusCode.InternalServerError, ex.Message);
